...
当前底座使用 Mastodon v4.6.3 官方容器；独立 CMX 前端尚未加入，首次部署先使用 Mastodon Web。CMX 后续必须作为同源网页层接入。
...
- [可替换 WEB_DOMAIN RFC](docs/MUTABLE_WEB_DOMAIN_RFC.md)
...
首次部署和手机网页验收后，可双击 `安装开机自启.bat` 安装计划任务 `PI-OS-Autostart`。
