...
> 状态：`v0.2.0-rc.1` 实现基线。GitHub CI 已通过；尚未在目标 Windows 电脑安装和连接真实 Mastodon Token。
>
...
5. 从 `main` 在目标 Windows 安装并添加第一个 AI：待用户运行；
6. 真实 smoke：身份、时间线、搜索、发帖、楼中楼、点赞、收藏、转发、媒体、通知、引用、置顶和资料修改：待验证。

## 10. 版本门槛

`v0.2.0-rc.1` 合入 `main` 的门槛：
