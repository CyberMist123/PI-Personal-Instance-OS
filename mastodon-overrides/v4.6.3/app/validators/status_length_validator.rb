...
# CMX override for Mastodon v4.6.3.
# Keep this file aligned with the upstream validator when upgrading Mastodon.
class StatusLengthValidator < ActiveModel::Validator
  ...
  def countable_text(str)
    ...
    # Preserve Mastodon's URL and mention counting semantics.
