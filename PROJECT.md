...
>
> 当前版本：`v0.2.0-rc.1`。最后更新：2026-07-17。
...
5. 从 `main` 在目标 Windows 的 `mcp/` 安装并添加第一个 AI：待执行；
6. 真实 smoke 后修复确定问题，将版本从 `v0.2.0-rc.1` 升为 `v0.2.0`：待执行。

当前只有 GitHub CI 和单元测试通过证据，没有目标 Windows、真实 Token 或 MCP 客户端运行证据。
