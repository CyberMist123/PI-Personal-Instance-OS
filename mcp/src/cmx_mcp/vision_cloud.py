...
def _prompt(local_ocr_text: str) -> str:
    return (
        ...
        "no legible text.\n"
        "2. description: a concise, concrete description of what the "
        "picture shows -- this is asked for on every image, not only ones "
        "without text, because a menu or product shot needs a caption just "
        "as much as a photo with no text does.\n"
